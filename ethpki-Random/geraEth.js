...
while (nameList[k].slice(0,5) != nameList[1000].slice(0,5)) {
    //++++ Cria para cada Address Account um ethript de teste, baseado no "baseethpkiCriptografado,js"
    shell.cat('baseEth.js').toEnd('/home/rogerio/AppsMC2/ethpki-Random/testDir/' +nameList[k].slice(0,5) +'.js');

    //++++ Aloca testAddress de para cada arquivo criado no intem anterior
    shell.exec(`sed -i "s/testAddress = ''/testAddress ='${nameList[k].slice(6,52)}'/" /home/rogerio/AppsMC2/ethpki-Random/testDir/` + nameList[k].slice(0,5) +'.js')

	//++++ Cria as chamadas dos arquivos ".js" através de arquivos ".py"
    shell.cat('baseCallEth.py').to('/home/rogerio/AppsMC2/ethpki-Random/testDir/call'  +nameList[k].slice(0,5) +'.py');

    //++++ Aloca testAddress para cada chamada criada no intem anterior
	shell.exec(`sed -i "s/'node'/'node ${nameList[k].slice(0,5)}.js'/" /home/rogerio/AppsMC2/ethpki-Random/testDir/call` + nameList[k].slice(0,5) +'.py')
	k++
}
...
var form = '"' 
var arr = new Array();
shell.exec('cp /home/rogerio/Apps/baseParaleliza.py paraleliza-10.py')
...
var form = '"' 
var arr = new Array();
shell.exec('cp /home/rogerio/Apps/baseParaleliza.py paraleliza-20.py')
...
var form = '"' 
var arr = new Array();
shell.exec('cp /home/rogerio/Apps/baseParaleliza.py paraleliza-30.py')
...
var form = '"' 
var arr = new Array();
shell.exec('cp /home/rogerio/Apps/baseParaleliza.py paraleliza-40.py')
...
var form = '"' 
var arr = new Array();
shell.exec('cp /home/rogerio/Apps/baseParaleliza.py paraleliza-50.py')
...
var form = '"' 
var arr = new Array();
shell.exec('cp /home/rogerio/Apps/baseParaleliza.py paraleliza-100.py')
...
var form = '"' 
var arr = new Array();
shell.exec('cp /home/rogerio/Apps/baseParaleliza.py paraleliza-200.py')
...
var form = '"' 
var arr = new Array();
shell.exec('cp /home/rogerio/Apps/baseParaleliza.py paraleliza-300.py')
...
var form = '"' 
var arr = new Array();
shell.exec('cp /home/rogerio/Apps/baseParaleliza.py paraleliza-400.py')
...
var form = '"' 
var arr = new Array();
shell.exec('cp /home/rogerio/Apps/baseParaleliza.py paraleliza-500.py')
...
var form = '"' 
var arr = new Array();
shell.exec('cp /home/rogerio/Apps/baseParaleliza.py paraleliza-600.py')
...
var form = '"' 
var arr = new Array();
shell.exec('cp /home/rogerio/Apps/baseParaleliza.py paraleliza-700.py')
...
var form = '"' 
var arr = new Array();
shell.exec('cp /home/rogerio/Apps/baseParaleliza.py paraleliza-800.py')
...
var form = '"' 
var arr = new Array();
shell.exec('cp /home/rogerio/Apps/baseParaleliza.py paraleliza-900.py')
...
var form = '"' 
var arr = new Array();
shell.exec('cp /home/rogerio/Apps/baseParaleliza.py paraleliza-1000.py')
...
//++++++++++++++++++++++++++++++++++++++++++++
shell.exec('mv paraleliza*.py ./testDir/')
